...
sentence_list = ["At seven o'clock this evening I'm going to eat mushroom ravioli.",
                 ...
                 "02+12=15\n", "Have you ever heard of the tragedy of darth plagueis the wise?*&*", "!!!??!?!?1/!/"]
for sentence in sentence_list:
    tokens = nltk.word_tokenize(sentence)
    print(tokens)

# add some sentences to see what it does to various usages of numbers, special characters, and punctuation. DONE
...
# come up with some sentences where you think the automatic tagger might get the answer right or wrong? ----it probably has an in-built dictioary of words, much like an actual dictionary, that is uses to helo identify word types. It might get an answer wrong if the word is strange, colloquial, or rarely if ever used by anyone in the english language. 

sentence1list = ["i am supercalafragilisticexpealidocious.", "he is flipping around in a flipping flippant manner"]
for  sentence1 in sentence1list:
    tokens2 = nltk.word_tokenize(sentence1)
    tag = nltk.pos_tag(tokens2)
    print(sentence1)
for word in tag:
    print(word)
...
"""
words = frankenstein_text.findall("<a>(<.*>)<man>") 
print(words)
words2 = frankenstein_text.findall("<who>(<.*>)<their>")
print(words2)
words3 = frankenstein_text.findall("<the>(<.*>)<of>")
print(words3)
...
concordances2 = frankenstein_text.concordance("believe")
print(concordances2)

concordances3 = frankenstein_text.concordance("regard")
print(concordances3)
...
line.
"""
# comment what you think is happening below----- it very clearly finds the frequency of the texts most commonly found words. 
